...
public final class GrpcJobManagementModelConverters {
    ...
    private static Volume toCoreVolume(com.netflix.titus.grpc.protogen.Volume grpcVolume) {
        if (grpcVolume.getVolumeSourceCase() == Volume.VolumeSourceCase.SHAREDCONTAINERVOLUMESOURCE) {
        ...
        } else if (grpcVolume.getVolumeSourceCase() == Volume.VolumeSourceCase.SAASVOLUMESOURCE) {
