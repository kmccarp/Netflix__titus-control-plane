...
public class StubbedJobStore implements JobStore {
    ...
    public int getIndex(String taskId) {
        return getIndexAndResubmit(taskId).map(com.netflix.titus.common.util.tuple.Pair::getLeft).orElseThrow(() -> new IllegalStateException("Task " + taskId + " is not registered in store"));
    }
